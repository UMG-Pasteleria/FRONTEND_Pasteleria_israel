...
//     getData();
//   }, []);
//   // // // // //-----CAPTURAR DATOS DE NUEVO PRODUCTO MATERIA------//
//   const { handleSubmit, register } = useForm();
//   const enviarMaterias = handleSubmit((data) => {
//     console.log(data);
//     fetch(URL, {
//       method: "POST",
...
//   const handleDelete = async (id_mateprima) => {
//     const res = await fetch(`https://8086zfpm-3000.use.devtunnels.ms/MateriaPri/${id_mateprima}`, {
//       method: "DELETE",
//     });
//     // const data = await res.json();
//     console.log(res);
//     setMaterias(
//       materias.filter((mate_prima) => mate_prima.id_mateprima !== id_mateprima)
//     );
//   };
...
//   //---------------------ALERTAS ----------------------------------
//   const mostrarAlerta = (id_mateprima) => {
//     swal
//       .fire({
...
//           <br></br>
//           {/* ------------------- MODAL AGREGAR NUEVO PRODUCTO, MATERIA-------------- */}
//           <ModalP
//             estado={estadoModal1}
