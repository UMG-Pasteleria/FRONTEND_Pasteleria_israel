...
function TamPastel() {
  ...
  const handleDelete = async (idtampast) => {
    ...
    console.log(res);
    setTamPasteles(
      tampasteles.filter((tampastel) => tampastel.idtampast !== idtampast)
    );
  };
  ...
  if (!search) {
    ...
    result = tampasteles.filter((datos) =>
