...
const PDFGenerator = ({ data }) => {
  const generatePDF = () => {
    ...
    const tableColumn = ['No.', 'Nombre', 'NIT', 'Teléfono', 'Correo', 'Direccion'];
    const tableRows = [];

    data.forEach((item) => {
      const rowData = [++contador, item.nombre_pr, item.nit_pr, item.telefono_pr, item.correo_pr, item.direccion_pr];
